...
For when you just need to float away from your geocomputation tasks for a moment. Inspired by [xkcd 353](https://xkcd.com/353/), this is a classic Python easter egg.

While there were rumors of an "Antigravity IDE" from Google in early 2026, it turned out to be a clever April Fools' prank. However, we've "installed" the classic joke as a command-line utility for you.
...
If the command isn't available, you can always run it directly from Python:
