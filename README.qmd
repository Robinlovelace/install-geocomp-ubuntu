...
[Antigravity](https://antigravity.google) is an AI-powered, "agent-first" Integrated Development Environment (IDE) released by Google. It is a heavily modified fork of VS Code designed to orchestrate autonomous AI agents powered by Gemini.

### Installation via APT Repository (Recommended)

To install Antigravity on Ubuntu 26.04, use the official Google repository:
